<template>
     <div class="testbox">
      <form action="/">
        ...
        <div class="item">
          ...
          <div class="name-item">
            <input type="text" v-model="name" name="name" placeholder="First" required/>
        ...
        <div class="item">
          ...
          <div class="name-item">
            <input type="text" v-model="email" name="email" placeholder="Eamil" required/>
  ...
  <input type="file" name="file" accept="file/*">
        ...
        <div class="btn-block">
          <button type="submit" @click.prevent="AddAgency" href="/">Save Agency</button>
...
export default {
  ...
  methods:{
    AddAgency(){
      axios.post('http://localhost:8000/api/admin/create?api_password=2172000',this.$data)
      .then(response=>{
