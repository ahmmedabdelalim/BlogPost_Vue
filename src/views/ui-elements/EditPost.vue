                ...
                <div class="modal-content">
                    <form enctype="multipart/form-data">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group">
                                <label>image :</label>
                                <img :src="PostToEdit.image" style="height:80px;width:80px;border:1px solid #999">
                                <input type="file" class="form-control"  @change="OnImageChange" required>
                            </div>
                        </div>
                        <div class="modal-footer">
                            
                            <input type="submit" class="btn btn-success" value="Edit" @click.prevent="UpdatedPost">
                        </div>
                    </form>
                </div>
            </div>
    ...
    computed:{
     ...
     methods:{
      ...
      UpdatedPost()
      {
            ...
            formdata.append('user_id',this.PostToEdit.user_id)

            axios.post("http://127.0.0.1:8000/api/admin/updatepost",formdata,config)
            .then(response=>{
                console.log(response);
                this.PostToEdit.image=response.data.Post.image
               /* this.title = '';
                this.body = '';
                this.image = '';
                this.category='';*/
