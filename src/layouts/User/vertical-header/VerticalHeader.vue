        ...
        <b-navbar-nav class="ml-auto">
          ...
          <b-nav-item-dropdown right no-caret>
            ...
            <b-dropdown-item href="#" class="d-flex align-items-center">
             <b-button variant="primary">Profile</b-button>
            </b-dropdown-item>
            <b-dropdown-item href="#" class="d-flex align-items-center">
            <b-button variant="primary">Setting  </b-button>
            </b-dropdown-item>
            <b-dropdown-item href="#" class="d-flex align-items-center">
              <b-button variant="primary"  @click.prevent="performLogout" >Sign Out</b-button>
            </b-dropdown-item>
          </b-nav-item-dropdown>
        </b-navbar-nav>
      </b-collapse>
